...
class Perceptron:
    def __init__(this):
        ...
        this.hidden_w = np.loadtxt('hid_w_onl.csv', delimiter=',')
        this.out_w = np.loadtxt('out_w_onl.csv', delimiter=',')
...
def save_result(data_1, data_2):
    np.savetxt("hid_w_onl.csv", data_1, delimiter=',')
    np.savetxt("out_w_onl.csv", data_2, delimiter=',')
